...
export declare class TicketsServices {
    ...
    stripe: Stripe;
    constructor(ticketModel: Model<Ticket>, eventTicketModel: Model<EventTicket>, emailService: EmailService);
    createTicket(ticket: CreateTicketDto): Promise<Stripe.Response<Stripe.Checkout.Session>>;
    approveTicket(id: string, quantity: number): Promise<import("mongoose").Document<unknown, {}, Ticket> & Ticket & {
        _id: Types.ObjectId;
    }>;
    confirmTicket(id: string): Promise<import("mongoose").Document<unknown, {}, Ticket> & Ticket & {
        _id: Types.ObjectId;
    }>;
    getTickets(id: string): Promise<import("mongoose").Document<unknown, {}, Ticket> & Ticket & {
        _id: Types.ObjectId;
    }>;
    getTicketFromticketsType(id: string): Promise<Omit<import("mongoose").Document<unknown, {}, Ticket> & Ticket & {
        _id: Types.ObjectId;
    }, never>[]>;
    createCheckoutSession(ticketId: string, host: string): Promise<Stripe.Response<Stripe.Checkout.Session>>;
    getAllTickets(user: any): Promise<Omit<import("mongoose").Document<unknown, {}, Ticket> & Ticket & {
        _id: Types.ObjectId;
    }, never>[]>;
}
