...
export declare class TicketsController {
    ...
    constructor(ticketsService: TicketsServices);
    getTickets(user: any): Promise<Omit<import("mongoose").Document<unknown, {}, import("src/tickets/schemas/tickets.schema").Ticket> & import("src/tickets/schemas/tickets.schema").Ticket & {
        _id: import("mongoose").Types.ObjectId;
    }, never>[]>;
    getTicket(id: string): Promise<import("mongoose").Document<unknown, {}, import("src/tickets/schemas/tickets.schema").Ticket> & import("src/tickets/schemas/tickets.schema").Ticket & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    getTicketFromticketsType(id: string): Promise<Omit<import("mongoose").Document<unknown, {}, import("src/tickets/schemas/tickets.schema").Ticket> & import("src/tickets/schemas/tickets.schema").Ticket & {
        _id: import("mongoose").Types.ObjectId;
    }, never>[]>;
    approveTicket(id: string, quantity: number): Promise<import("mongoose").Document<unknown, {}, import("src/tickets/schemas/tickets.schema").Ticket> & import("src/tickets/schemas/tickets.schema").Ticket & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    confirmTicket(id: string): Promise<import("mongoose").Document<unknown, {}, import("src/tickets/schemas/tickets.schema").Ticket> & import("src/tickets/schemas/tickets.schema").Ticket & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    createTicket(createTicketDto: CreateTicketDto): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.Checkout.Session>>;
}
