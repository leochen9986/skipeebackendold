...
export declare class StripeService {
    ...
    stripe: Stripe;
    constructor(siteModel: Model<Site>, userModel: Model<User>, emailService: EmailService);
    setStripeCommission(siteId: string, commissionDto: StripeCommissionDto): Promise<import("mongoose").Document<unknown, {}, Site> & Site & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    createOrGetStripeAccount(userId: string): Promise<{
        canAcceptPayments: boolean;
        account: Stripe.Response<Stripe.Account>;
        accountLink: string;
        dashboardLink: any;
    }>;
    getStripeDashboardLink(accoutnId: string): Promise<string>;
