...
export declare class StripeController {
    ...
    getStripeAccountLink(user: any): Promise<{
        canAcceptPayments: boolean;
        account: import("stripe").Stripe.Response<import("stripe").Stripe.Account>;
        accountLink: string;
        dashboardLink: any;
    }>;
    setStripeComission(siteId: string, commissionDto: StripeCommissionDto): Promise<import("mongoose").Document<unknown, {}, import("src/sites/schemas/sites.schema").Site> & import("src/sites/schemas/sites.schema").Site & {
